...
static const unordered_map<string, void (*)(LEDEffect, Adafruit_NeoPixel,
	Adafruit_NeoPixel, sensors_event_t)> rainbowEffectStyles = {
	"static"
...
static void ledRainbow(LEDEffect chosenEffect, Adafruit_NeoPixel ledsLeft,
    Adafruit_NeoPixel ledsRight, sensors_event_t _) {
    // get func from map like in effects.h
}

// rainbow (style="moving")
// TODO: brightness setting maybe?
static void rainbowEffectMoving(LEDEffect chosenEffect, Adafruit_NeoPixel ledsLeft,
	Adafruit_NeoPixel ledsRight, sensors_event_t _) {
...
//gyro brightness rainbow (style="gyro")
static void rainbowEffectGyro(LEDEffect chosenEffect, Adafruit_NeoPixel ledsLeft,
	Adafruit_NeoPixel ledsRight, sensors_event_t gyro) {
	if (gyro == NULL) {
		rainbow(chosenEffect, ledsLeft, ledsRight, gyro);
		return;
	}
